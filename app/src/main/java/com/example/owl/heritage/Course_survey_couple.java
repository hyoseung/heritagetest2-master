 ...
 */
public class Course_survey_couple extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.course_survey_couple);

        RadioGroup rd = (RadioGroup) this.findViewById(R.id.group1);
        rd.setOnCheckedChangeListener(optionOnClickListene);

        palaceB=(RadioButton)findViewById(R.id.date);
        exprienceB=(RadioButton)findViewById(R.id.exprience_c);
        religionB=(RadioButton)findViewById(R.id.religion_c);
        walkB=(RadioButton)findViewById(R.id.picture);
        schoolB=(RadioButton)findViewById(R.id.school_c);

        course_db = new Course_DB(getApplicationContext(), "COURSE.db", null, 1);
        select = (Button) findViewById(R.id.select_button_c);
        ...
        cancel = (Button) findViewById(R.id.cancel_button_c);
