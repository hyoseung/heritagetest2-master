 ...
 */
public class Course_survey_family extends AppCompatActivity {
    private Context mContext = this;
    private ArrayList<String> list;
    private String theme;

    private RadioButton palaceB,educationB,religionB, picnicB,schoolB;
    private Button cancel,select;
    private Course_DB course_db;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.course_survey_family);

        RadioGroup rd = (RadioGroup) this.findViewById(R.id.group2);
        rd.setOnCheckedChangeListener(optionOnClickListene);

        palaceB=(RadioButton) findViewById(R.id.palace);
        educationB=(RadioButton)findViewById(R.id.edu);
        religionB=(RadioButton)findViewById(R.id.religion_fa);
        picnicB=(RadioButton)findViewById(R.id.picnic);
        schoolB=(RadioButton)findViewById(R.id.school_fa);

        course_db = new Course_DB(getApplicationContext(), "COURSE.db", null, 1);
        select = (Button) findViewById(R.id.select_button_fa);
        ...
        cancel = (Button) findViewById(R.id.cancel_button_fa);
